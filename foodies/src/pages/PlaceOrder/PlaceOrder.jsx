                    ...
                    <div className="col-md-5 col-lg-4 order-md-last"><h4
                        ...
                        <ul className="list-group mb-3">
                            ...
                            <li key={food.id} className="list-group-item d-flex justify-content-between lh-sm">
                                ...
                                <span className="text-body-secondary">&#8377;{(food.price * quantities[food.id]).toFixed(2)}</span></li>
                            ))}
                        ...
                        <form className="needs-validation" noValidate>
                            ...
                            <div className="row g-3">
                                <div className="col-sm-6"><label htmlFor="firstName" className="form-label">First
                                    name</label> <input
                                    type="text" className="form-control" id="firstName" placeholder="Kanha" value=""
                                    required/>

                                </div>
                                <div className="col-sm-6"><label htmlFor="lastName" className="form-label">Last
                                    name</label> <input
                                    type="text" className="form-control" id="lastName" placeholder="Kudale" value=""
                                    required/>
